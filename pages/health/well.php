...
<head>
    ...
    <title>Well-being-Test(WHO-5)</title>
    <!-- Add Bootstrap CSS -->
...
<body>
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="#">Well being Test</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="index.php">Mental Health</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container mt-5">
        <h1 class="text-center mb-5">Well-being-Test (WHO-5)</h1>
